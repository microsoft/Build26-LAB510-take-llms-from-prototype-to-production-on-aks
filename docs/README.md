...
**Note:** To view the full spec of an InferenceProviderConfig, including capabilities and selection rules, run the command below.
...
**Note:** Notice you selected a provider explicitly in the UI. The dashboard guides you through provider selection, but when deploying via kubectl, you can omit it entirely and let the controller auto-select based on your spec.
...
**Tip:** The pods can take up to 7-10 minutes to be ready.
