...
Ready? Let's dive into [Module 1: First Deployment & Core Concepts](1-core-concepts.md) to deploy your first model and explore the core abstractions of AI Runway.
